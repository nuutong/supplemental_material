...
set ylabel "Jaccard index between BinaryMUC and BinaryMUC+UC" font 'Helvetica,12'
...
plot "overlap_binarymuc_binaryucmuc" using 1:2 with circles  lc rgb 'dark-violet'
